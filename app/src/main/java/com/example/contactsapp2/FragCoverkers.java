...
public class FragCoverkers extends Fragment {
...
//    private Boolean track = true;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AdapterFamilyAddContacts adapterFamilyAddContacts = new AdapterFamilyAddContacts(MainActivity._list,getContext());
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapterFamilyAddContacts);
