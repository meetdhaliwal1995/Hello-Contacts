...
public class AdapterAddContact extends RecyclerView.Adapter<AdapterAddContact.ViewHolder> {

    private List<PhnContacts> _list;
    private Context context;

    public AdapterAddContact(List<PhnContacts> _list, Context context) {
        this._list = _list;
