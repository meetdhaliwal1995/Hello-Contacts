...
//        getContactList();
        ...
        AdapterFriendsAddContacts adapterFriendsAddContacts = new AdapterFriendsAddContacts(MainActivity._list,getContext());
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapterFriendsAddContacts);
