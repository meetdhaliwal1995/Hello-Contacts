...
public class Frag2AddContact extends Fragment {

    RecyclerView recyclerView;
//    private List<PhnContacts> _list = new ArrayList<>();
...
//    private Boolean track = true;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textView = view.findViewById(R.id.cancel_btn);
...
//        getContactList();
        ...
        AdapterAddContact adapterAddContact = new AdapterAddContact(MainActivity._list,getContext());
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapterAddContact);
    }
